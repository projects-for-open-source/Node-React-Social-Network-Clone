...
public class SwaggerConfig {
	 ...
	 */
	ApiInfo apiInfo = new ApiInfo("RESTful Web Service documentation",
	    "This pages documents RESTful Web Service endpoints", "1.0", "https://github.com/richard-vu", contact,
	...
	public Docket apiDocket() {
		...
		Docket docket = new Docket(DocumentationType.SWAGGER_2).protocols(new HashSet<>(Arrays.asList("HTTP")))
		    .apiInfo(apiInfo).select().apis(RequestHandlerSelectors.basePackage("com.richard.application"))
